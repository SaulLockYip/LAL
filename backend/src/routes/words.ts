...
wordsRouter.post('/', async (req: Request, res: Response) => {
  try {
    const {
      articleId,
      word,
...
wordsRouter.get('/:id', async (req: Request, res: Response) => {
  try {
...
wordsRouter.delete('/:id', async (req: Request, res: Response) => {
  try {
    const id = req.params.id as string;
    const parsedId = parseInt(id);
...
wordsRouter.post('/lookup', async (req: Request, res: Response) => {
  try {
...
wordsRouter.post('/derivation', async (req: Request, res: Response) => {
  try {
    const { word } = req.body;
...
wordsRouter.post('/etymology', async (req: Request, res: Response) => {
  try {
    const { word } = req.body;
